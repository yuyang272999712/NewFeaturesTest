...
public class SwipeLayout extends FrameLayout {
    ...
    private boolean mClickToClose = true;//点击关闭滑动状态的item
    ...
    public SwipeLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        int dragEdgeChoices = a.getInt(R.styleable.SwipeLayout_drag_edge, DRAG_RIGHT);//默认右侧可以滑动
    ...
    private Rect computeSurfaceLayoutArea(boolean open) {
        ...
        if (open) {
            if (mCurrentDragEdge == DragEdge.Left) l = getPaddingLeft() + mDragDistance;
    ...
    private Rect computeBottomLayoutAreaViaSurface(ShowMode mode, Rect surfaceArea) {
        ...
        if (mode == ShowMode.PullOut) {
            if (mCurrentDragEdge == DragEdge.Left) bl = rect.left - mDragDistance;
            else if (mCurrentDragEdge == DragEdge.Right) bl = rect.right;
            else if (mCurrentDragEdge == DragEdge.Top) bt = rect.top - mDragDistance;
            else bt = rect.bottom;
            ...
            if (mCurrentDragEdge == DragEdge.Left) br = bl + mDragDistance;
