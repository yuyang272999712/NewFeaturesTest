 ...
 * 继承自ImageView
 */
public class CircleImageByXfermodeView extends ImageView {
    private Paint mPaint;
    private Xfermode mXfermode = new PorterDuffXfermode(PorterDuff.Mode.DST_IN);
    //用于显示形状的遮罩（不了解请参考Paint.setXfermode的用法）
    ...
    public CircleImageByXfermodeView(Context context) {
        this(context, null);
    }

    public CircleImageByXfermodeView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleImageByXfermodeView(Context context, AttributeSet attrs, int defStyleAttr) {
