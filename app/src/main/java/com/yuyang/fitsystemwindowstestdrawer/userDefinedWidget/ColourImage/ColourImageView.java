...
/**
 * 使用扫描线种子填充算法
 * 算法：http://blog.csdn.net/orbit/article/details/7343236
 */
public class ColourImageView extends ImageView {
    ...
    public ColourImageView(Context context, AttributeSet attrs) {
        ...
        mBorderColor = a.getColor(R.styleable.ColourImageView_colour_border_color, -1);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //以宽度为标准，等比例缩放view的高度
        setMeasuredDimension(width, getDrawable().getIntrinsicHeight()*width/getDrawable().getIntrinsicWidth());
