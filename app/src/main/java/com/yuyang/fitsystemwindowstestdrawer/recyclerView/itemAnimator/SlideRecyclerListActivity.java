...
/**
 * 关于RecyclerList的item动画简单实现
 */
public class SlideRecyclerListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slide_recycler_list);
        initView();
        initData();
        initListener();
    }
