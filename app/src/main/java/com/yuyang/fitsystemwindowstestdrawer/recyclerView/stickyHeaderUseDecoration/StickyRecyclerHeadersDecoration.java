package com.yuyang.fitsystemwindowstestdrawer.recyclerView.stickyHeaderUseDecoration;
...
import com.yuyang.fitsystemwindowstestdrawer.recyclerView.stickyHeaderUseDecoration.caching.HeaderProvider;
import com.yuyang.fitsystemwindowstestdrawer.recyclerView.stickyHeaderUseDecoration.caching.HeaderViewCache;
import com.yuyang.fitsystemwindowstestdrawer.recyclerView.stickyHeaderUseDecoration.calculation.DimensionCalculator;
import com.yuyang.fitsystemwindowstestdrawer.recyclerView.stickyHeaderUseDecoration.rendering.HeaderRenderer;
import com.yuyang.fitsystemwindowstestdrawer.recyclerView.stickyHeaderUseDecoration.util.LinearLayoutOrientationProvider;
import com.yuyang.fitsystemwindowstestdrawer.recyclerView.stickyHeaderUseDecoration.util.OrientationProvider;
...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            //ZHU yuyang mHeaderPositionCalculator.hasNewHeader() 用于判断当前position是否需要有header
