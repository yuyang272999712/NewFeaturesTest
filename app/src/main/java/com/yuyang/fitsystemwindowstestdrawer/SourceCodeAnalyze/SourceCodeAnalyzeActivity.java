...
public class SourceCodeAnalyzeActivity extends AppCompatActivity {
    ...
    public void gotoLayoutInflateFactoryActivity(View view){
        Intent intent = new Intent(this, LayoutInflateFactoryActivity.class);
        startActivity(intent);
    }
    ...
    public void gotoLoaderUseActivity(View view){
        Intent intent = new Intent(this, LoaderAboutActivity.class);
        startActivity(intent);
    }
