package com.yuyang.fitsystemwindowstestdrawer.viewPagerIndicator.bannerIndicator;
...
public class CircleIndicator extends LinearLayout {
    ...
    private int mAnimatorResId = R.animator.banner_indicator_default_animator;
    private int mAnimatorReverseResId = 0;
    private int mIndicatorBackgroundResId = R.drawable.banner_indicator_white_radius;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.banner_indicator_white_radius;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mAnimatorResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_animator,
                R.animator.banner_indicator_default_animator);
        ...
        mIndicatorBackgroundResId =
                typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable,
                        R.drawable.banner_indicator_white_radius);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.banner_indicator_default_animator, 0, R.drawable.banner_indicator_white_radius, R.drawable.banner_indicator_white_radius);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mAnimatorResId = (mAnimatorResId == 0) ? R.animator.banner_indicator_default_animator : mAnimatorResId;
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.banner_indicator_white_radius
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
