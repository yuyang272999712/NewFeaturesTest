...
public class MaterialRangeSlider extends View {
    ...
    private int HORIZONTAL_PADDING = 80;
    private int DEFAULT_TOUCH_TARGET_SIZE = Math.round(DensityUtils.dp2px(getContext(), 40));
    private int DEFAULT_UNPRESSED_RADIUS = 15;
    private int DEFAULT_PRESSED_RADIUS = 40;
    private int DEFAULT_INSIDE_RANGE_STROKE_WIDTH = 8;
    private int DEFAULT_OUTSIDE_RANGE_STROKE_WIDTH = 4;
    ...
    public void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            TypedArray styledAttrs = getContext().obtainStyledAttributes(attrs, R.styleable.MaterialRangeSlider, 0, 0);
    ...
    private void getDefaultColors() {
        colorControlNormal = Color.parseColor("#ff0099cc");
        colorControlHighlight = Color.parseColor("#ff000000");
    ...
    private void getDefaultMeasurements() {
        pressedRadius = Math.round(DensityUtils.dp2px(getContext(), DEFAULT_PRESSED_RADIUS));
        unpressedRadius = Math.round(DensityUtils.dp2px(getContext(), DEFAULT_UNPRESSED_RADIUS));
        insideRangeLineStrokeWidth = Math.round(DensityUtils.dp2px(getContext(), DEFAULT_INSIDE_RANGE_STROKE_WIDTH));
        outsideRangeLineStrokeWidth = Math.round(DensityUtils.dp2px(getContext(), DEFAULT_OUTSIDE_RANGE_STROKE_WIDTH));
    }
